...
class Character{
  ...
  getInfo(){return `This is a ${this.type} character named ${this.name}.`}
...
class NPC extends Character{
  ...
  dialogue(){return `${this.name}: ${this.phrase}`}
}
...
fireSpitter.addSuperPower('x-ray vision');
